...
1. Download `npcs.json`, `items.json`, `storagevaults.json`, `areas.json`, `attributes.json`, `skills.json`, `abilities.json`, `tsysclientinfo.json`, and `recipes.json` from the [CDN data](https://cdn.projectgorgon.com/v457/data/).
